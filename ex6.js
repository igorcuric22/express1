...
app.get('/',(req,res)=>{
    res.sendFile(path.join(__dirname, 'popx6.html'));
    console.log(path.join(__dirname, 'popx6.html'));
});
...
app.put('/api/put/:id', (req, res) => {
   // const { name } = req.body;
    ...
    db.run("update products set name=? where id=?;",[req.body.name,id],function(err,rows)
   {
